...
def main():
	...
	sun = Celestial(50, 0, winWidth/2, winHeight/2, 0, winWidth, winHeight, False, win, 3, [255,255,255], [100,100,100], [0,0,0])
	sun.drawCelestial()
	
	# Creating and drawing Mercury
	mercury = Celestial(10, sun.getRadius() + 80, sun.getCentreX(), sun.getCentreY(), 100, winWidth, winHeight, True, win, 2, [255,255,255], [100,100,100], [255,255,255])
	mercury.drawCelestial()
	
	# Creating and drawing Venus
	venus = Celestial(20, sun.getRadius() + 160, sun.getCentreX(), sun.getCentreY(), 150, winWidth, winHeight, True, win, 2, [255,255,255], [100,100,100], [255,255,255])
	venus.drawCelestial()
	
	# Creating and drawing Earth
	earth = Celestial(30, sun.getRadius() + 240, sun.getCentreX(), sun.getCentreY(), 200, winWidth, winHeight, True, win, 2, [255,255,255], [100,100,100], [255,255,255])
	earth.drawCelestial()
	
	# Creating and drawing The Moon
	moon = Celestial(5, earth.getRadius() + 20, earth.getCentreX(), earth.getCentreY(), 200/12, winWidth, winHeight, False, win, 1, [255,255,255], [100,100,100], [255,255,255])
	moon.drawCelestial()
	
	# Creating and drawing Mars
	mars = Celestial(25, sun.getRadius() + 320, sun.getCentreX(), sun.getCentreY(), 180, winWidth, winHeight, True, win, 2, [255,255,255], [100,100,100], [255,255,255])
	mars.drawCelestial()
	
	# Creating and drawing Jupiter
	jupiter = Celestial(40, sun.getRadius() + 400, sun.getCentreX(), sun.getCentreY(), 250, winWidth, winHeight, True, win, 2, [255,255,255], [100,100,100], [255,255,255])
